...
const NGEN, NPOP, SYSTEMSIZE = Int32(1), Int32(50), Int32(20)			# 100, 30, 30 -> 15'
const INVTEMPERATURE, EXTERNALFIELD = 0.7, 0.1
const REPRATE, MUTRATE, SELSTRENGTH = 10^5., 2., 1.
const DELTAX, DELTATOFFSET = .5, 0.1
const NITERATION, NSAMPLINGS = Int32(10^3)*SYSTEMSIZE^2, Int32(50)
